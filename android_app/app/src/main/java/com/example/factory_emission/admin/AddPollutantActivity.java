...
public class AddPollutantActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_pollutant);
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new DoAddPollutant().execute();
            }
        });
    }
    class DoAddPollutant extends AsyncTask<String, String, String> {
        @Override
        ...
        public String doInBackground(String... args) {
            ...
            try {
                ...
                JSONObject parser = jsonParser.makeHttpRequest("https://legalcounsel14441.helioho.st/add_pollutant.php", "POST", parameters);
